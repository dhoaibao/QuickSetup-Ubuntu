...
sudo nala install -y git zsh neofetch vlc gh wget curl nodejs npm neovim ibus-unikey gnome-tweaks gnome-shell-extension-manager flatpak gnome-software-plugin-flatpak
